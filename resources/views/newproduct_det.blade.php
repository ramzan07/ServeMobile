    ...
    <div id="wrapper">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                    ...
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(img/product-img/product-2.jpg);" class="">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(img/product-img/product-3.jpg);" class="">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(img/product-img/product-4.jpg);" class="">
                                    </li>
                                </ol>
        ...
        <section class="you_may_like_area clearfix">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="you_make_like_slider owl-carousel owl-theme owl-loaded">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2982px, 0px, 0px); transition: 1s; width: 3834px;"><div class="owl-item cloned" style="width: 396px; margin-right: 30px;"><div class="single_gallery_item">
                                <!-- Product Image -->
                            ...
                            </div></div><div class="owl-item cloned" style="width: 396px; margin-right: 30px;"><div class="single_gallery_item">
                                <!-- Product Image -->
                                <div class="product-img">
                            ...
                            </div></div><div class="owl-item" style="width: 396px; margin-right: 30px;"><div class="single_gallery_item">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/product-1.jpg" alt="">
                                    <div class="product-quicview">
                            ...
                            </div></div><div class="owl-item cloned active" style="width: 396px; margin-right: 30px;"><div class="single_gallery_item">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/product-1.jpg" alt="">
                                    <div class="product-quicview">
